        ...
        <Container>
          <div>
            ...
            <p>
              Ebiblo App
              <br />
              7/12 Ramu Parade, Heidelberg West, VIC 3081
              <br />
              Australia
              <br />
              Owner contact email: contact@ebiblo.com
            </p>
            <h4>Types of Data collected</h4>

            <p>
              Among the types of Personal Data that this Application collects,
              by itself or through third parties, there are: first name; phone
            ...
            <p>
              ...
              activity, as well as the following: Contacting the User and Access
              to third-party accounts. For specific information about the
              Personal Data used for each purpose, the User may refer to the
              section “Detailed information on the processing of Personal Data”.
            </p>
            <h4>Facebook permissions asked by this Application</h4>
            <p>
              ...
              service allows this Application to connect with the User's account
              on the Facebook social network, provided by Facebook Inc. For more
              information about the following permissions, refer to the Facebook
              permissions documentation and to the Facebook privacy policy. The
            ...
            <h5>Facebook account access (this Application)</h5>
            <p>
            ...
            <p>
              ...
              indicated by the form’s header. Personal Data collected: email
              address; first name; phone number.
            </p>
